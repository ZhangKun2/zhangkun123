<template>
    <div>
        ...
        <div class="rules">
            ...
            <div class="wenzi">
                Oyelite brings an amazing event!
                When you recharge through PhonePe UPI,
                you can get an extra reward for every single recharge!
            </div>
        </div>
        <div class="bangdan">
            <div class="bangdan1">
...
onMounted(()=>{
    let scaleW=window.innerWidth/375;
    let fontSize = 10 * scaleW;
